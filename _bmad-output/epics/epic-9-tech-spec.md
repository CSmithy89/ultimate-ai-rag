...
| `_bmad-output/implementation-artifacts/stories/_template.md` | Story template with Standards Coverage + Dev Notes |
...
| Path | Change |
|------|--------|
| `_bmad-output/implementation-artifacts/stories/*` | Apply updated template fields for new stories |
