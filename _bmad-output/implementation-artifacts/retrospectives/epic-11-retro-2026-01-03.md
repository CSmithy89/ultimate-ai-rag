...
- Story files live in `_bmad-output/implementation-artifacts/stories/`, while sprint-status points to `_bmad-output/implementation-artifacts` as the story location.
...
- Story location mismatch between sprint-status and `_bmad-output/implementation-artifacts/stories/`.
