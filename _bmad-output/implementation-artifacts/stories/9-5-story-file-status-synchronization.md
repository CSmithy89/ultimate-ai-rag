...
and compare to `_bmad-output/implementation-artifacts/stories/*.md` status lines.
...
- Documented the status update process in `_bmad-output/implementation-artifacts/stories/README.md`.
...
- _bmad-output/implementation-artifacts/stories/4-4-knowledge-graph-visualization.md
