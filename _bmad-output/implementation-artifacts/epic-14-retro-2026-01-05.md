...
|------|----------|-------|--------|
| Add A2A integration tests to Epic 19-F2 | MEDIUM | Dev | Epic 19 |
| Implement stdio transport for MCP | MEDIUM | Dev | Epic 18 or new |
| Add tenant isolation automated tests | HIGH | Dev | Next epic |
| Create endpoint spec compliance tests | MEDIUM | Dev | Epic 19 |

### For Process Improvement

| Item | Priority | Owner | Target |
|------|----------|-------|--------|
| Add security checklist to story template | HIGH | SM | Immediate |
| Create RFC 7807 linter rule | MEDIUM | Dev | Epic 18 |
| Document error code conventions in AGENTS.md | LOW | Dev | Done (added in this epic) |
