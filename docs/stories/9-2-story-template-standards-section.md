...
- [x] Update story template in `docs/stories/` with Standards Coverage section (AC: 1)
...
- Created `docs/stories/_template.md` with standards checklist.
- Added `docs/stories/README.md` with usage guidance and review expectations.
